...
1. `<hr>` or `---` - горизонтально прямая линия



2. `<br>` or `пустая строка(Enter)` - переносы



3. `<!-- -->` - комментарии как в HTML



4. <details><summary>👈 Игнор <code>* # ` ...</code> markdown символов = экранирование (с помощью): <code>\</code></summary><p>
...
5. <details><summary>👈 Игнор <code><></code> HTML-tag с помощью <code><</code> = <code>& lt;</code> и <code>></code> = <code>& gt;</code> </summary><p>

    - `<` = `&lt;` [`инфо`](https://www.w3schools.com/html/html_entities.asp#:~:text=less%20than-,%26lt%3B)
    - `>` = `&gt;` [`инфо`](https://www.w3schools.com/html/html_entities.asp#:~:text=greater%20than-,%26gt%3B)
    - .
    - Пример:
        - в гайде "18. Свернутый-раздел <code>&lt;details&gt;&lt;summary&gt;</code>"
    - .
    - Игнор `<>` HTML-tag с помощью `<` = [`&lt;`](https://www.w3schools.com/html/html_entities.asp#:~:text=less%20than-,%26lt%3B) и `>` = [`&gt;`](https://www.w3schools.com/html/html_entities.asp#:~:text=greater%20than-,%26gt%3B)
    </p><hr></details>



6. <details><summary>👈 Заголовки: <code># - ###### (1-6)</code></summary><p>
...
7. <details><summary>👈 Списки: <code>-</code> or <code>1.</code></summary><p>

    - `1. Text` - Упорядоченный список
        - можно у каждой нужной строки ставить `1.` (автоматом продолжится нумерация)
        - так же в начале строки можно поставить любое число
...
8. <details><summary>👈 Таблицы: <code>|</code> + <code>-</code></summary><p>
...
9. <details><summary>👈 Текст стили: <code>* ** *** ~~ _</code> </summary><p>
...
10. <details><summary>👈 Ссылки: <code>[title](./)</code></summary><p>
    ...
    - Относительная ссылка
      - `[LICENSE](./LICENSE.md)`
    - [Ссылки на код тоже можно](https://docs.github.com/en/get-started/writing-on-github/working-with-advanced-formatting/creating-a-permanent-link-to-a-code-snippet)
        - <img width="220px" alt="link-code" title="" src="img/link-code.jpg">
    </p><hr></details>



11. <details><summary>👈 Картинки: <code>![title](./)</code></summary><p>
...
12. <details><summary>👈 Код между: <code>` `</code> = однострочный</summary><p>
...
13. <details><summary>👈 Код между: <code>``` ```</code>, <code>```` ````</code> = многострочный</summary><p>
...
14. <details><summary>👈 Цитирование текста: <code>></code></summary><p>
...
15. <details><summary>👈 Списки задач: <code>- [ ]</code>, <code>- [x]</code></summary><p>
...
16. <details><summary>👈 Эмодзи (<code>emoji</code>): ✌️</summary><p>
    ...
    - Всё эмодзи тут [`Emoji - шпаргалка`](https://github.com/ikatyang/emoji-cheat-sheet/blob/master/README.md)
      ...
      - [Погода](https://github.com/ikatyang/emoji-cheat-sheet/blob/master/README.md#time) :fire: :star: :zap: :high_brightness: :sun_with_face: :star:
...
17. <details><summary>👈 Сноски <code>[^1]</code>, <code>[^1]:</code></summary><p>
